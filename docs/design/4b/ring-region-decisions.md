...
| Pit anchor (the Ring scene's spawn) | the skeleton's pit lane "Boxengasse an T13", segment 199642470-0 (way 199642470), drape-covered | R18 | chosen for the ring build (4B-4, the Conductor's ruling 2: certification sessions start at the pit area) — the car spawns on the Boxengasse centreline at chainage 20.0 m, 28.2 m before its junction (312821860) with the Sabine-Schmitz-Kurve, x 2037.199 / z -1355.401 (region metres), road height 627.44 m, yaw 33.19° (heading along the pit lane toward the loop, direction (-0.5474, -0.8369) in x-east / z-south); scenes/eifel_ring.tscn's Car transform carries it; R puts the car back there |
